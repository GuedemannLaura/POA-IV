...
if(Beta != 0){ 
  ...
  point_estimates_results                <- data.frame(CaT, stIV, CF, DiD)
  ...
  lower_CI_results                <- data.frame(lower_CaT, lower_stIV, lower_CF, lower_DiD)
  ...
  upper_CI_results                <- data.frame(upper_CaT, upper_stIV, upper_CF, upper_DiD)
  ...
  # coverage ----
  # check if true value is in the CI (--> TRUE)
